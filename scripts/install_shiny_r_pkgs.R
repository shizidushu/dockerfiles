...
# -shiny
list_of_packages <- c("promises", "shinydashboard", "shinyWidgets",  "shinyjs", "shinyTime", "listviewer", "gt", "pdftools", "shinydisconnect", "waiter")
...
devtools::install_github("shizidushu/shinytvc")